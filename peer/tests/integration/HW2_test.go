...
func Test_HW2_Integration_Scenario(t *testing.T) {
	...
	nodeA := z.NewTestNode(t, studentFac, studentTransp, "127.0.0.1:8000", studentOpts...)
	nodeB := z.NewTestNode(t, referenceFac, referenceTransp, "127.0.0.1:8001", refOpts...)
	nodeC := z.NewTestNode(t, referenceFac, referenceTransp, "127.0.0.1:8002", refOpts...)
	nodeD := z.NewTestNode(t, studentFac, studentTransp, "127.0.0.1:8003", studentOpts...)
